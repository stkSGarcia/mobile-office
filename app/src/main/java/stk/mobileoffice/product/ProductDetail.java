    ...
    private static class MHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (target != null) {
                ...
                target.text_number.setText(data[1]);
                target.text_price.setText(data[2]);
                target.text_unit.setText(data[3]);
                target.text_class.setText(data[4]);
                target.text_intro.setText(data[5]);
                target.text_remark.setText(data[6]);
